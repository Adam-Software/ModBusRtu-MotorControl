...
#define SPEED 9600                   //Определяем скорость устройства
...
//!!!!ВАЖНО  
// EEPROM.put(9, 22);        //при первой загрузке раскомментировать для записи адреса в EEPROM, потом закоментировать и прошить повторно
//!!!!ВАЖНО 
